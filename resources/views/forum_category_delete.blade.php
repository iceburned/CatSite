...
<head>
    ...
    <script class="u-script" type="text/javascript" src="{{'forum/js/nicepage.js'}}" defer=""></script>
...
<section class="u-clearfix u-section-3" id="carousel_03c7">
    <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Are you sure you want to delete "{{$record[0]->title}}"?</h1>
        ...
        <div class="u-form u-form-1">
            <form action="{{url('custom-delete/'.$id)}}" method="POST">
                @csrf
                <button type="submit"
