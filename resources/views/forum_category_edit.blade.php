...
@section('nav')
    ...
    <section class="u-clearfix u-section-3" id="carousel_03c7">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h1 class="u-text u-text-default u-text-1">Edit Category</h1>
            ...
            <div class="u-form u-form-1">
                <p></p>
                <form action="{{url('custom-edit/'.$id)}}" method="POST">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="title"></label><input type="text" placeholder="Title" id="title"
                    ...
                    <div class="form-group mb-3">
                        <label for="description"></label><input type="text" placeholder="Description" id="description"
